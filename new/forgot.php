...
<body>
    ...
    <div class="parallax-overlay"></div>
		...
		<form name="sentMessage" id="contactForm" method="post"	 action="forgot_check_user.php"  novalidate>  
		 <div class="col-md-6">
		<input type="text" class="form-control" 
		placeholder="Username" id="name" required name="username" data-validation-required-message="Please enter your Username" />
