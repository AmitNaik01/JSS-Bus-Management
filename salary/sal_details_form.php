                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <form name="form1" id="formID" method="post" action='sal_details_insert.php' style="margin-left: 25px ;display:flex;" autocomplete="off">
                                        <div align="center">
                                            <table width="600" border="0" align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="70">
                                                        ...
                                                        <input name="ename" type="text" id="ename" class=" form-control validate[required],custom[onlyLetter]">
                                                    </td>
                                                </tr>
                                                <!-- <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="70">
                                                        ...
                                                        <input name="basic" type="text" id="basicy" class="form-control validate[required]">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td height="70">
                                                        <!-- <input name="admin_city" type="text" id="admin_city" class="form-control validate[required,custom[onlyLetter]"> -->
                                                        <input name="allow" type="text" id="allow" class="form-control validate[required]">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td height="70">
                                                        <!-- <input name="admin_city" type="text" id="admin_city" class="form-control validate[required,custom[onlyLetter]"> -->
                                                        <input name="spl_allow" type="text" id="spl_allow" class="form-control validate[required]">
                                                    </td>
                                                </tr>
                                                <!-- <tr>
